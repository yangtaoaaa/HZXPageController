...
-(void)setupSubViews
{
    ...
    [textView addSubview:textLabel]; self.textView = textView; // 动画开始按钮
...
-(void)beginBtnClick { [self rightAnimation]; }
...
-(void)rightAnimation
{
    ...
    [UIView animateWithDuration:5.f animations:^{ self.textView.layer.transform = CATransform3DMakeRotation(M_PI/2, 0, 0, 1); }completion:^(BOOL finished) {
